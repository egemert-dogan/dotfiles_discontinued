...
import XMonad.Layout.NoBorders as NoBorders
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Restart XMobar
   -- , ((modm .|. shiftMask, xK_b     ), spawn "killall xmobar; xmobar --recompile &")
...
--
myLayout = NoBorders.lessBorders NoBorders.Never $ avoidStruts (tiled ||| Mirror tiled ||| noBorders Full)
  where
...
help = unlines ["The default modifier key is 'alt'. Default keybindings:",
    ...
    "",
    "-- quit, or restart",
    "mod-Shift-q  Close focused windows",
